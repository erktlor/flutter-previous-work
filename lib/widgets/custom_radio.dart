...
class _RadioState<T> extends State<CustomRadio<T>> with TickerProviderStateMixin {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    if (!position.isDismissed) {
      ...
      final Paint innerPaint = Paint()
        ...
        ..style = PaintingStyle.fill
        ..strokeWidth = 0.0;
      canvas.drawCircle(center, _kInnerRadius * position.value, innerPaint);
    } else {
      final Paint paint = Paint()
        ..color = Color.lerp(fillColor, radioColor, position.value)
        ..style = PaintingStyle.fill
        ..strokeWidth = 1.0;
      canvas.drawCircle(center, _kOuterRadius, paint);
      ...
      final Paint paintStroke = Paint()
        ...
        ..strokeWidth = 1.0;
      canvas.drawCircle(center, _kOuterRadius, paintStroke);
    }
  }
