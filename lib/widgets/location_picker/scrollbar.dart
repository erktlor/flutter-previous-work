...
const Color _kLightColor =  Color(0xFFDBDAD4);
const Color _kDarkColor =  Color(0xFF585661);
Color _getScrollBarColor(context) => isLightTheme(context) ? _kLightColor : _kDarkColor;

const double _kScrollbarThickness = 8.0;
const double _kScrollbarThicknessDragging = 8.0;
const Radius _kScrollbarRadius = Radius.circular(150.0);
const Radius _kScrollbarRadiusDragging = Radius.circular(4.0);

const _kScrollbarRightMargin = 14.0;
...
class _CupertinoScrollbarState extends State<AppCupertinoScrollbar> with TickerProviderStateMixin {
  ...
  void didChangeDependencies() {
    ...
    if (_painter == null) {
      ...
      _painter
        ...
        ..color = _getScrollBarColor(context)
//        ..padding = MediaQuery.of(context).padding;
        ..padding = EdgeInsets.only(right: _kScrollbarRightMargin);
    }
  }
