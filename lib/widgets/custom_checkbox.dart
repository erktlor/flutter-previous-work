...
class _CheckboxState extends State<CustomCheckbox> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return _CheckboxRenderObjectWidget(
      ...
      fillColor: themeData.toggleButtonsTheme.fillColor ?? Colors.white,
...
const Radius _kEdgeRadius = Radius.circular(0);
const double _kStrokeWidth = 1.3;
...
class _RenderCheckbox extends RenderToggleable {
  ...
  void _drawBorder(Canvas canvas, RRect outer, double t, Paint paint) {
    ...
    Paint paintClear = Paint()
      ..color = Color.lerp(fillColor, fillColor, t * 4.0)
      ..style = PaintingStyle.fill;
    canvas.drawRect(Rect.fromCenter(center: outer.center, width: size,height: size  ), paintClear);
  ...
  void _drawCheck(Canvas canvas, Offset origin, double t, Paint paint) {
    ...
    const Offset start = Offset(_kEdgeSize * 0.3, _kEdgeSize * 0.47);
    const Offset mid = Offset(_kEdgeSize * 0.42, _kEdgeSize * 0.6);
    const Offset end = Offset(_kEdgeSize * 0.70, _kEdgeSize * 0.3);
    if (t < 0.5) {
    ...
    canvas.drawPath(path, paint..strokeWidth = _kStrokeWidth * 2);
  }
